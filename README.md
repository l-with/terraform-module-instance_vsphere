...
| <a name="input_digital_ocean_region_slug_pattern_country_code_mapping"></a> [digital\_ocean\_region\_slug\_pattern\_country\_code\_mapping](#input\_digital\_ocean\_region\_slug\_pattern\_country\_code\_mapping) | n/a | `list(map(string))` | <pre>[<br>  {<br>    "ams3": "NL",<br>    "blr1": "IN",<br>    "fra1": "DE",<br>    "lon1": "GB",<br>    "nyc1": "US",<br>    "nyc3": "US",<br>    "sfo2": "US",<br>    "sfo3": "US",<br>    "sgp1": "SG",<br>    "syd1": "AU",<br>    "tor1": "CA"<br>  }<br>]</pre> | no |
